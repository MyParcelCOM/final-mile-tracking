...
class FinalMileCarrier
{
    ...
    private const FINAL_MILE_CARRIERS = [
        ...
        'IN' => ['name' => self::INDIA_POST, 'url' => 'https://www.indiapost.gov.in/_layouts/15/DOP.Portal.Tracking/TrackConsignment.aspx'],
        'ID' => ['name' => self::POS_INDONESIA, 'url' => 'https://www.posindonesia.co.id/en/tracking'],
        'IE' => ['name' => self::AN_POST, 'url' => 'https://www.anpost.com/'],
        'IT' => ['name' => self::POSTE_ITALIANE, 'url' => 'https://www.poste.it/cerca/index.html#/risultati-spedizioni/%s'],
        ...
        'MX' => ['name' => self::MEXICO, 'url' => 'https://www.correosdemexico.gob.mx/SSLServicios/SeguimientoEnvio/seguimientoportal2.aspx?guia=%s'],
